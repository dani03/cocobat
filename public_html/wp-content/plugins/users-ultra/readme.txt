...
= 1.5.94(06-26-2017) =
* Improvement - Facebook Login Features were rebuilt. Now the login uses JS SDK to login. Please update since the previous FB lib was deprecated.


= 1.5.93(05-04-2017) =
* Improvement - Issues with mail feature, we have updated the use of wp_mail function.


= 1.5.92(02-10-2017) =
* Improvement - Tweaks on coding for Social Features. Facebook, Twitter & Linked In .
* Improvement - Languge Improvements.
* Improvement - Conflict with premium themes.

= 1.5.91(12-12-2016) =
* Improvement - LinkedIN API update.
* Improvement - Tweaks for new version 4.7 of WordPress.

= 1.5.90(11-11-2016) =
* Bug Fix - We've fixed error message displayed on the main page of the plugin.

= 1.5.89(09-26-2016) =
* Improvement - Minor css Tweaks for new WordPress version.

= 1.5.88(09-24-2016) =
* Improvement - Tweaks for new WordPress version.
* New Feature - PayPal Payments hook.
...
* Improvement - WooCommerce API tweak.


= 1.5.85(06-27-2016) =
* Improvement - This new version includes an update on the coding in order to make the plugin load faster. Now the load time is 2 seconds faster.
...
* Improvement - Friends load issue. Thank you very much Diego daigo75.

= 1.5.82(05-03-2016) =
* Improvement - Settings module fields sanitization.


= 1.5.81(04-21-2016) =
* Improvement - Issue when editing and deleting posts through the Users Dashboard.

= 1.5.80(04-19-2016) =
* Improvement - Front-end Publisher tweaked for new WP version.
* Improvement - Minor css tweaks for WP 4.5.

= 1.5.79(04-13-2016) =
* Improvement - Minor Tweaks on css styles.
* Improvement - Tweaks for new version of WP.
* Improvement - Reflected Cross-site scripting vulnerability on Settings Tab. We have implemented nonce in order to prevent Coss-site attacks.

= 1.5.78(04-5-2016) =
* Bug Fix - Redirection issue on user login.
* Bug Fix - Small css bug with premium themes.
* Improvement - Language update.

= 1.5.77(03-25-2016) =
* Improvement - Nonce implementation on UU Settings and Permalinks. Please update 

= 1.5.76(03-18-2016) =
* Improvement - Reflected Cross-site scripting vulnerability. Please update we have implemented nonce on WP settings page to avoid cross-site scripting vulnerability. Please update
* Improvement - External Control of File Name or Path. We have implemented some tweaks in order to make the UU Dashboard much more safe.
* Improvement - Stored Cross-site scripting vulnerability on /wp-admin/admin.php?page=userultra&tab=mail. Please update, nonce has been implemented.


= 1.5.75(03-10-2016) =
* New Feature - Placeholders added to registration fields.
* Improvement - Issue with hook do_action('wp_head').
* Improvement - Spanish language updated.
* Improvement - Portuguese language updated.

= 1.5.74(03-03-2016) =
* Improvement - New hook added which can be used on Social media registration.
* Improvement - Coding Improvement on Fields Customizer Module.
* Improvement - Drag&Drop conflict with some premium themes.


= 1.5.73(02-21-2016) =
* Improvement - Language files update.
* Improvement - Date picker localization.
* Improvement - Hook for following. Now you use the uultra_following_message to do your custom actions right after a user follows other user.


= 1.5.72(02-02-2016) =
* Improvement - Coding clean up.
* New Feature - Social Sign up hook.

= 1.5.71(01-15-2016) =
* Improvement - Languages updated.
* Improvement - User's dashboard, we have reduced some css styles and we tweak some divs because there were some conflicts with premium themes.
